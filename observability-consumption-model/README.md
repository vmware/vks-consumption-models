...
The content is intended to support the implementation examples described in the paper and to make the configuration artifacts easier to review, reuse, and adapt.